...
//    }
    ...
    public Conta(String nome, String endereco, int cpf, int idade, int numeroCelular, double salario, int numeroConta, double saldo, String tipoConta) {
    	super(nome, endereco, cpf, idade, numeroCelular, salario);
        this.numeroConta = numeroConta;
        this.saldo = saldo;
